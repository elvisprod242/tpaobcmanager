...
import { mockTempsConduite, mockRapports, mockConducteurs } from '../services/mockData';
...
export const DrivingTime = ({ selectedPartnerId, partners, globalYear }: { selectedPartnerId: string, partners: Partenaire[], globalYear: string }) => {
    ...
    const [analyses, setAnalyses] = useState<TempsConduite[]>(mockTempsConduite);
